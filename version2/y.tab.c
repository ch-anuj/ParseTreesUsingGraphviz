...
{
       0,   132,   132,   139,   149,   156,   166,   173,   174
};
#endif
...
{
  "$end", "error", "$undefined", "NUM", "PLUS", "MULTIPLY", "'('", "')'",
...
#line 1348 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 149 "b_2.y" /* yacc.c:1646  */
    {
						cout<<"3";
						temp1 = addNodeA(nodeId++,strdup("E"),&tailA,&headA);
						(yyvsp[0].value).nodeId  = temp1;
						makeChild((yyval.value).nodeId,(yyvsp[0].value).nodeId,headA);
						}
...
#line 1385 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 173 "b_2.y" /* yacc.c:1646  */
    {cout<<"6";}
#line 1391 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 174 "b_2.y" /* yacc.c:1646  */
    {
						cout<<"7";
