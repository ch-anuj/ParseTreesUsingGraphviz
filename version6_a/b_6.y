...
%type <value> primary_expr add_expr mul_expr relational_expr equality_expr log_and_expr log_or_expr assgn_expr stmt_list stmt if_stmt decl_stmt declarators
...
decl_stmt
			: type_spec declarators ENDCOLON{
									cout<<"76";
...
declarators
      ...
      | declarators ENDCOLON IDENTIFIER{
									cout<<"80";
									temp1 = addNodeA(nodeId++,strdup("declarators"),&tailA,&headA);
